...
function Library.new(options, gameSubTitle)
    ...
    HideBtn.MouseEnter:Connect(function() Tween(HideBtn, {TextColor3 = "Theme:SubText"}, 0.1) end)
    HideBtn.MouseLeave:Connect(function() Tween(HideBtn, {TextColor3 = "Theme:Muted"}, 0.1) end)
...
function Library:Notify(title, text, duration, icon)
    ...
    New("UIStroke", {Color = "Theme:ElementHover", Thickness = 1}, Toast)
    New("UIPadding", {
...
function Library:CreatePage(pageName, icon)
    ...
    local function SelectPage()
        ...
        Tween(PageLabel, {TextColor3 = "Theme:Text"})
        if IconImg then Tween(IconImg, {ImageColor3 = "Theme:Text"}) end
    end
    ...
    function Page:CreateSubTab(subName)
        ...
        SubBtn.MouseButton1Click:Connect(function()
            ...
            Tween(SubBtn, {BackgroundTransparency = 0, TextColor3 = "Theme:Text"})
        end)
        ...
        function SubTab:CreateCard(cardTitle, cardIcon)
            ...
            function Card:AddToggle(text, default, callback)
                ...
                New("TextLabel", {
                    ...
                    Font = Enum.Font.BuilderSans, TextSize = 12,
                    TextXAlignment = Enum.TextXAlignment.Left,
                    BackgroundTransparency = 1,
                }, Frame)
            ...
            function Card:AddDropdown(text, list, default, callback)
                ...
                DropBtn.MouseEnter:Connect(function() Tween(DropBtn, {BackgroundColor3 = "Theme:ElementHover"}, 0.15) end)
                DropBtn.MouseLeave:Connect(function() Tween(DropBtn, {BackgroundColor3 = "Theme:Element"}, 0.15) end)
                ...
                New("UIStroke", {Color = "Theme:Stroke", Thickness = 1}, OptionsFrame)
